...
public class SelectUserAdapter  extends BaseAdapter {
    ...
    int b;
    CheckBox cc;
    public List<String> name,phone;


    public SelectUserAdapter(List<SelectUser> selectUsers, Context context,TextView numCount,int bb,CheckBox abc,List<String> num,List<String> name) {
        _data = selectUsers;
        _c = context;
