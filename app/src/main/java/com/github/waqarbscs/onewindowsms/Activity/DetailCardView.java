...
public class DetailCardView extends AppCompatActivity {
    List<SmsModel> data;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor= DbHelper.getDbHelper(this).getDetail();
        cursor.moveToFirst();
        ...
        Recycler_View_Adapter1 adapter = new Recycler_View_Adapter1(data, getApplication());
